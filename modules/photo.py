...
# =========================
# PINTEREST VIDEO DETECTOR
# =========================
#
# Pinterest selalu nyisipin og:image (thumbnail cover)
# di HTML-nya, WALAUPUN pin-nya sebenarnya video.
# Makanya perlu dicek dulu apakah ini pin video,
# biar gak ke-treat sebagai foto secara salah.
#

def pinterest_is_video(soup, html_text):
...
def pinterest_photos(url):
    ...
    # =====================
    # SKIP KALAU INI VIDEO PIN
    # =====================

    if pinterest_is_video(soup, r.text):

        logger.info(
            "Pinterest terdeteksi video, "
            "diserahkan ke video engine"
        )
